/*
 * Source: EstacionMantencionWebException.java - Generated by OBCOM SQL Wizard 1.158
...
public class EstacionMantencionWebException extends Exception
{
    private static final long serialVersionUID = 1L;
    private final WebFaultInfo webFaultInfo;

    /**
     * Constructs a new {@code EstacionMantencionWebException} with cause and subject.
     *
     * @param cause the cause of the exception.
     * @param subject the subject of the exception.
     */
    public EstacionMantencionWebException(final Throwable cause, final String subject)
    {
