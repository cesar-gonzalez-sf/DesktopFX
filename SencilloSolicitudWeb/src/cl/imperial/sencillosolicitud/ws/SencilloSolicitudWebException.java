/*
 * Source: SencilloSolicitudWebException.java - Generated by OBCOM SQL Wizard 1.158
...
public class SencilloSolicitudWebException extends Exception
{
    private static final long serialVersionUID = 1L;
    private final WebFaultInfo webFaultInfo;

    /**
     * Constructs a new {@code SencilloSolicitudWebException} with cause and subject.
     *
     * @param cause the cause of the exception.
     * @param subject the subject of the exception.
     */
    public SencilloSolicitudWebException(final Throwable cause, final String subject)
    {
