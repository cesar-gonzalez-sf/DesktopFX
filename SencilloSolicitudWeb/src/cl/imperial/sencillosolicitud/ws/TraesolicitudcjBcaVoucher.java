/*
 * Source: TraesolicitudcjBcaVoucher.java - Generated by OBCOM SQL Wizard 1.158
...
/**
 * Row of result set {@code VOUCHER} of procedure {@code SolicitudSencillo$TraeSolicitudCJ_bca}.
 *
 * <pre>
 ...
 *   #Column  TIPO_ENVIO        NVARCHAR
 * #EndResultSet
 * </pre>
 *
 * @author Cesar Luis Gonzalez-Rubio Chacin (Imperial S.A.)
 */
@XmlRootElement(name = "traesolicitudcjBcaVoucher")
@XmlType(name = "TraesolicitudcjBcaVoucher")
public class TraesolicitudcjBcaVoucher implements Serializable
{
    ...
    /**
     * Constructs a new {@code TraesolicitudcjBcaVoucher} instance.
     */
    public TraesolicitudcjBcaVoucher()
    {
    }
    ...
    /**
     * Returns the value of property {@code tipoEnvio}.
     *
     * @return the current value of the property.
     */
    ...
    /**
     * Changes the value of property {@code tipoEnvio}.
     *
     * @param value the new value of the property.
     */
    public void setTipoEnvio(final String value)
    {
