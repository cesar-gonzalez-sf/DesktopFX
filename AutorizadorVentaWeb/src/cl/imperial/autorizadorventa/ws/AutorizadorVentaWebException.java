/*
 * Source: AutorizadorVentaWebException.java - Generated by OBCOM SQL Wizard 1.160
...
public class AutorizadorVentaWebException extends Exception
{
    private static final long serialVersionUID = 1L;
    private final WebFaultInfo webFaultInfo;

    /**
     * Constructs a new {@code AutorizadorVentaWebException} with cause and subject.
     *
     * @param cause the cause of the exception.
     * @param subject the subject of the exception.
     */
    public AutorizadorVentaWebException(final Throwable cause, final String subject)
    {
