IF OBJECT_ID(N'dbo.SECURITYFX$TERMINAL_PUT', N'P') IS NOT NULL 
    DROP PROCEDURE dbo.SECURITYFX$TERMINAL_PUT
GO

CREATE PROCEDURE dbo.SECURITYFX$TERMINAL_PUT
--------------------------------------------------------------------------------
...
BEGIN
    ...
    IF (@CREATED = 0) BEGIN
        SET @AUDIT_EVENT = 15;
        SET @AUDIT_MESSAGE = 'Terminal fue modificado: ' + @TERMINAL_NAME;
    END
    ELSE BEGIN
        SET @AUDIT_EVENT = 13;
        SET @AUDIT_MESSAGE = 'Terminal fue creado: ' + @TERMINAL_NAME;
    END;
