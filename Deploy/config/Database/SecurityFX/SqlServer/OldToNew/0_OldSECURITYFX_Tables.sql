...
IF OBJECT_ID(N'EcuACCPRV', N'U') IS NOT NULL
    DROP TABLE EcuACCPRV
GO
IF OBJECT_ID(N'EcuACCLOG', N'U') IS NOT NULL
    DROP TABLE EcuACCLOG
GO
IF OBJECT_ID(N'EcuACCCTX', N'U') IS NOT NULL
    DROP TABLE EcuACCCTX
GO
IF OBJECT_ID(N'EcuACCCON', N'U') IS NOT NULL
    DROP TABLE EcuACCCON
GO
IF OBJECT_ID(N'EcuACCC2P', N'U') IS NOT NULL
    DROP TABLE EcuACCC2P
GO
IF OBJECT_ID(N'EcuACCC2U', N'U') IS NOT NULL
    DROP TABLE EcuACCC2U
GO
IF OBJECT_ID(N'EcuACCCAP', N'U') IS NOT NULL
    DROP TABLE EcuACCCAP
GO
IF OBJECT_ID(N'EcuACCU2P', N'U') IS NOT NULL
    DROP TABLE EcuACCU2P
GO
IF OBJECT_ID(N'EcuACCUSU', N'U') IS NOT NULL
    DROP TABLE EcuACCUSU
GO
IF OBJECT_ID(N'EcuACCPER', N'U') IS NOT NULL
    DROP TABLE EcuACCPER
GO
IF OBJECT_ID(N'EcuACCNET', N'U') IS NOT NULL
    DROP TABLE EcuACCNET
GO
IF OBJECT_ID(N'EcuACCFAM', N'U') IS NOT NULL
...
(
    ...
    CONSTRAINT EcuACCU2P_PK PRIMARY KEY CLUSTERED (CODIGO_ADI,CODIGO_ECU)
)
GO
