/*
 * Source: TipoDocumentoWebException.java - Generated by OBCOM SQL Wizard 1.160
...
public class TipoDocumentoWebException extends Exception
{
    private static final long serialVersionUID = 1L;
    private final WebFaultInfo webFaultInfo;

    /**
     * Constructs a new {@code TipoDocumentoWebException} with cause and subject.
     *
     * @param cause the cause of the exception.
     * @param subject the subject of the exception.
     */
    public TipoDocumentoWebException(final Throwable cause, final String subject)
    {
