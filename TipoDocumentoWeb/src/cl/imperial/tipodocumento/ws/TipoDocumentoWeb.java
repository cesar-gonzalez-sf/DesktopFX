/*
 * Source: TipoDocumentoWeb.java - Generated by OBCOM SQL Wizard 1.160
...
/**
 * The {@code TipoDocumento} Web Service.
 *
 * @author Cesar Luis Gonzalez-Rubio Chacin (Imperial S.A.)
 */
@WebService(targetNamespace = TipoDocumentoWeb.TNS)
public class TipoDocumentoWeb
{
    /** The Target Namespace of the Web Service. */
    public static final String TNS = "http://ws.tipodocumento.imperial.cl/tipodocumento";

    /** The Logger of the Web Service. */
    private static final Logger logger =
        Logger.getLogger(TipoDocumentoWeb.class.getName());
    ...
    @Resource(name = "TipoDocumentoDataSource")
    ...
    /**
     * Constructs a new {@code TipoDocumentoWeb} instance.
     */
    ...
    /**
     * Executes procedure {@code TipoDocumento$BuscaClienteRut_bca}.
     *
     * @param  vrutCliente {@code vRut_Cliente varchar(13)}.
     * @return the output parameters and result sets of the procedure.
     * @throws TipoDocumentoWebException if an error occurs.
     */
    ...
    public BuscaclienterutBcaResult buscaclienterutBca(
        @WebParam(name = "vrutCliente", targetNamespace = TNS) final String vrutCliente)
        throws TipoDocumentoWebException
    {
        ...
        try {
            ...
            try {
                result = BuscaclienterutBcaCaller.execute(getDataSource(), vrutCliente);
            ...
            throw new TipoDocumentoWebException(thrown, "buscaclienterutBca");
        }
        return result;
    }
        ...
        throws NamingException
    {
        if (dataSource == null) {
            final InitialContext context = new InitialContext();
            try {
                dataSource = (DataSource) context.lookup("java:comp/env/TipoDocumentoDataSource");
            } finally {
                context.close();
            }
        }
