 ...
 * generated in the cl.imperial.tipodocumento.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _BuscaclienterutBca_QNAME = new QName("http://ws.tipodocumento.imperial.cl/tipodocumento", "buscaclienterutBca");
    private final static QName _BuscaclienterutBcaCliente_QNAME = new QName("http://ws.tipodocumento.imperial.cl/tipodocumento", "buscaclienterutBcaCliente");
    private final static QName _BuscaclienterutBcaResponse_QNAME = new QName("http://ws.tipodocumento.imperial.cl/tipodocumento", "buscaclienterutBcaResponse");
    private final static QName _BuscaclienterutBcaResult_QNAME = new QName("http://ws.tipodocumento.imperial.cl/tipodocumento", "buscaclienterutBcaResult");
    private final static QName _Faultinfo_QNAME = new QName("http://ws.tipodocumento.imperial.cl/tipodocumento", "faultinfo");
    private final static QName _WebFaultInfo_QNAME = new QName("http://ws.tipodocumento.imperial.cl/tipodocumento", "webFaultInfo");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cl.imperial.tipodocumento.ws
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tipodocumento.imperial.cl/tipodocumento", name = "buscaclienterutBca")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tipodocumento.imperial.cl/tipodocumento", name = "buscaclienterutBcaCliente")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tipodocumento.imperial.cl/tipodocumento", name = "buscaclienterutBcaResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tipodocumento.imperial.cl/tipodocumento", name = "buscaclienterutBcaResult")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tipodocumento.imperial.cl/tipodocumento", name = "faultinfo")
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link WebFaultInfo }{@code >}
     */
    @XmlElementDecl(namespace = "http://ws.tipodocumento.imperial.cl/tipodocumento", name = "webFaultInfo")
